    ...
    <Layout style={{ minHeight: "100vh" }}>
      <Sider collapsible collapsed={collapsed} onCollapse={setCollapsed}>
        <div style={{ color: "white", padding: "20px", textAlign: "center" }}>
          <Title level={4} style={{ color: "white" }}>
            {collapsed ? "TMS" : "Teacher Management"}
          </Title>
        </div>
      ...
      <Layout>
        <Header style={{ background: "#fff", padding: 20, textAlign: "center" }}>
          <Title level={3}>Teacher Authority Dashboard</Title>
        </Header>
        <Content style={{ margin: "20px" }}>
          <div style={{ background: "#fff", padding: 24 }}>
            ...
            <Row gutter={16} style={{ marginBottom: 20 }}>
              <Col span={8}>
                <Card title="Classes" bordered>
                  {classes.length} classes
                </Card>
              </Col>
              <Col span={8}>
                <Card title="Students" bordered>
                  {students.length} students
                </Card>
              </Col>
              <Col span={8}>
                <Card title="Tasks Assigned" bordered>
                  {tasks.length} tasks
                </Card>
              </Col>
            </Row>
            ...
            <div style={{ marginBottom: 20 }}>
              <Title level={4}>Manage Classes</Title>
              <Input.Search
            ...
            <div>
              <Title level={4}>Manage Students</Title>
              <Form layout="inline">
                <Form.Item>
                  <Input
